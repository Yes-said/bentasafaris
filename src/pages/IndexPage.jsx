    ...
    <>
      ...
      >
        <div className="absolute inset-0 bg-black bg-opacity-50 flex flex-col justify-center items-center text-center">
          <h1 className="text-white text-5xl font-bold mb-4 hero-text">
            Discover the Wonders of Africa
          </h1>
          <p className="text-white text-lg mb-8 max-w-xl hero-text">
            Explore breathtaking safaris, unforgettable wildlife adventures, and immerse yourself in the rich culture of Africa.
          </p>
          <Link
            to="/tours"
            className="bg-yellow-500 text-gray-900 font-semibold px-8 py-4 rounded-full shadow-lg hover:bg-yellow-600 transition duration-300 hero-button"
          >
            Explore Tours
          </Link>
        </div>
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white shadow-lg rounded-lg overflow-hidden">
              ...
              />
              <div className="p-6">
                <h3 className="font-bold text-xl mb-2">Kenya Safari Adventure</h3>
            ...
            <div className="bg-white shadow-lg rounded-lg overflow-hidden">
              ...
              />
              <div className="p-6">
                <h3 className="font-bold text-xl mb-2">Tanzania Wildlife Safari</h3>
                <p className="text-gray-600 mb-4">
            ...
            <div className="bg-white shadow-lg rounded-lg overflow-hidden">
              ...
              />
              <div className="p-6">
                <h3 className="font-bold text-xl mb-2">Beach and Safari Combo</h3>
                <p className="text-gray-600 mb-4">
